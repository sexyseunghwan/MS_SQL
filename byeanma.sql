...
INSERT INTO dbo.BANKBOOK VALUES (N'������',1000);
INSERT INTO dbo.BANKBOOK VALUES (N'�Ǹ���',0);


UPDATE dbo.BANKBOOK SET umoney = umoney - 500 WHERE uname = N'������'
UPDATE dbo.BANKBOOK SET umoney = umoney + 500 WHERE uname = N'�Ǹ���'


UPDATE dbo.BANKBOOK SET umoney = umoney - 600 WHERE uname = N'������'
UPDATE dbo.BANKBOOK SET umoney = 500 WHERE uname = N'�Ǹ���'


BEGIN TRAN 
	UPDATE dbo.BANKBOOK SET umoney = umoney - 600 WHERE uname = N'������'
	UPDATE dbo.BANKBOOK SET umoney = umoney + 600 WHERE uname = N'�Ǹ���'
COMMIT TRAN
